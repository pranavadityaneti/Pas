/**
 * Standard retail vendor agreement body — Phase 0.1 (2026-06-14).
 *
 * Verbatim from the founder-team final PDFs. Grocery and Other Stores are
 * byte-identical except the section 3.3 commission line, so this one body is
 * shared and the commission text is injected via `commissionText`:
 *   - Grocery       → "two percent (2%)"
 *   - Other Stores  → "five percent (5%)"
 *   - Meat & Seafood → routed to Other Stores ("five percent (5%)")
 *
...
export function standardBody(commissionText: string): AgreementBody {
  return {
    bindingClause:
      'By signing this Agreement, completing onboarding, listing products or services, accepting orders, or otherwise using the Platform, the Merchant agrees to be bound by the terms contained herein.',
    sections: [
      {
        n: '1',
        ...
        clauses: [
          {
            ...
            text: 'PAS operates a technology platform that enables customers to discover merchants, browse products, place orders, schedule pickups, and access related services.',
          },
          {
            n: '1.2',
            title: 'Nature of Relationship',
            text: 'PAS acts solely as a technology intermediary facilitating interactions and transactions between customers and merchants through the Platform. PAS does not own merchant inventory, manufacture products, operate merchant premises, employ merchant personnel, control merchant operations, or act as the agent, representative, partner, employer, or legal representative of the Merchant.',
          },
          {
            n: '1.3',
            title: 'Independent Parties',
            text: 'Nothing in this Agreement shall be construed as creating a partnership, joint venture, agency, franchise, employment, or fiduciary relationship between PAS and the Merchant.',
          },
          {
            n: '1.4',
            title: 'Non-Exclusive Arrangement',
            text: 'The relationship established under this Agreement is non-exclusive. Either party may enter into similar arrangements with third parties.',
          },
        ],
      },
      {
        ...
        clauses: [
          ...
          { n: '2.3', text: 'All information, documentation, product descriptions, pricing information, photographs, trademarks, and business details provided to PAS are accurate, complete, and not misleading.' },
      ...
      },
      {
        ...
        clauses: [
          { n: '3.1', title: 'Onboarding Fee', text: 'The Merchant shall pay a one-time onboarding fee of INR 999 plus applicable taxes for each branch listed on the Platform.' },
          { n: '3.2', title: 'Additional Branches', text: 'The onboarding fee applies to a single outlet or branch only. Each additional outlet or branch added at onboarding or subsequently shall require payment of the applicable onboarding fee for such outlet or branch.' },
          { n: '3.3', title: 'Platform Commission', text: `PAS shall be entitled to a commission of ${commissionText} of the gross order value of each successfully completed order placed through the Platform.` },
          { n: '3.4', title: 'Taxes', text: 'All fees, commissions, and charges under this Agreement are exclusive of applicable taxes. GST and other applicable taxes shall be levied, collected, and remitted in accordance with applicable law.' },
          {
            n: '3.5',
            title: 'Settlement',
            text:
          ...
          { n: '3.6', title: 'Revision of Commercial Terms', text: 'PAS may revise commissions, onboarding fees, settlement schedules, or other commercial terms by providing reasonable prior notice through official communication channels.' },
        ],
      },
      {
        n: '4',
        ...
        clauses: [
          ...
          { n: '4.2', text: 'The Merchant shall comply with all laws applicable to its products, inventory, storage, packaging, advertising, sale, and business operations.' },
      ...
      },
      {
        ...
        clauses: [
          { n: '5.1', title: 'Product Quality and Authenticity', text: 'The Merchant shall be solely responsible for the quality, authenticity, safety, legality, storage, handling, packaging, labeling, condition, description, warranty obligations, and regulatory compliance of all products offered through the Platform and for ensuring that such products comply with all applicable laws, regulations, and industry standards.' },
          ...
          { n: '5.3', title: 'Operational Readiness', text: 'The Merchant shall maintain adequate staff, inventory, and operational readiness to fulfill accepted orders.' },
          { n: '5.4', title: 'Accurate Information', text: 'The Merchant shall maintain accurate, complete, and up-to-date information on the Platform, including its business hours, inventory availability, product information, pricing, store location, contact details, operational status, and any other information relevant to customer orders, pickups, or transactions.' },
        ],
      },
      {
        n: '6',
      ...
      },
      {
        ...
        clauses: [
          { n: '7.1', text: 'The Merchant shall process and fulfill accepted orders within applicable timelines communicated by PAS.' },
          { n: '7.2', text: 'The Merchant shall ensure accepted orders are available for pickup at the agreed pickup time.' },
          { n: '7.3', text: 'The Merchant shall maintain accurate operational status and availability on the Platform.' },
          { n: '7.4', text: 'Repeated failure to fulfill accepted orders may result in warnings, suspension, or termination.' },
          { n: '7.5', text: 'The Merchant shall not repeatedly accept and subsequently reject orders without valid operational reasons.' },
        ],
      },
      {
        n: '8',
        ...
        clauses: [
          { n: '8.1', text: 'Customer requests relating to cancellations, refunds, returns, exchanges, order issues, product concerns, service complaints, or transaction disputes shall be handled in accordance with PAS policies and applicable law.' },
          { n: '8.2', text: 'PAS may seek information from both the customer and the Merchant before making a determination.' },
          { n: '8.3', text: 'PAS shall review available information and make a commercially reasonable determination in accordance with applicable policies, available evidence, and applicable law.' },
          { n: '8.4', text: 'The Merchant agrees to cooperate with investigations and provide supporting information when reasonably requested.' },
          { n: '8.5', text: 'Where a refund, adjustment, credit, compensation, return, or exchange is approved, PAS may adjust future settlements accordingly.' },
        ],
      },
      {
        n: '9',
        ...
        clauses: [
          { n: '9.1', text: 'Customer information shall be used solely for legitimate transaction-related purposes.' },
          { n: '9.2', text: 'The Merchant shall not misuse, sell, disclose, transfer, or exploit customer information except as permitted by law.' },
          { n: '9.3', text: 'Both parties shall maintain the confidentiality of non-public business information obtained through the relationship.' },
          { n: '9.4', text: 'Confidentiality obligations shall survive termination of this Agreement.' },
        ],
      },
      {
        n: '10',
        ...
        clauses: [
          {
            ...
            bullets: ['Business name;', 'Store name;', 'Logos;', 'Product images;', 'Catalogues;', 'Marketing materials;'],
          },
          { text: 'for operating, promoting, marketing, and improving Platform services.' },
          { n: '10.2', text: 'The Merchant warrants that it possesses all rights necessary to grant such license.' },
        ],
      },
      {
        n: '11',
        ...
        clauses: [
          { n: '11.1', text: 'PAS may publish customer ratings, reviews, and feedback relating to the Merchant.' },
          { n: '11.2', text: 'The Merchant shall not manipulate, fabricate, purchase, incentivize, or otherwise interfere with review systems.' },
          { n: '11.3', text: 'PAS may moderate reviews in accordance with applicable policies and legal requirements.' },
        ],
      },
      {
        n: '12',
        ...
        clauses: [
          { n: '12.1', text: 'The Merchant shall reasonably cooperate with PAS in responding to lawful requests from courts, regulators, consumer authorities, law enforcement agencies, government departments, or other competent authorities.' },
          { n: '12.2', text: 'The Merchant shall promptly provide documents and information reasonably required in connection with investigations, disputes, audits, regulatory inquiries, or legal proceedings relating to transactions conducted through the Platform.' },
        ],
      },
      {
        n: '13',
        ...
        clauses: [
          { n: '13.1', text: 'PAS may monitor merchant performance to maintain platform quality, customer trust, and regulatory compliance.' },
          { n: '13.2', text: 'In assessing merchant performance, PAS may consider factors including customer complaints, order fulfillment performance, product quality, service quality, compliance history, operational reliability, responsiveness to customer concerns, adherence to Platform policies, and any other factors reasonably relevant to maintaining customer trust, operational standards, and regulatory compliance.' },
          { n: '13.3', text: 'Where repeated service deficiencies, customer complaints, operational failures, or policy violations are identified, PAS may issue written warnings to the Merchant.' },
          { n: '13.4', text: "Upon accumulation of three (3) warnings within a rolling twelve-month period, PAS may suspend or terminate the Merchant's access following review of the circumstances." },
          { n: '13.5', text: "PAS may immediately suspend, restrict, or terminate a Merchant's access to the Platform where it reasonably determines that such action is necessary due to fraud, suspected fraudulent activity, illegal conduct, serious safety concerns, regulatory or legal violations, material breach of this Agreement, misuse of the Platform, reputational risk to PAS, or any circumstance that may adversely affect customers, merchants, the Platform, or compliance with applicable law." },
        ],
      },
      {
        n: '14',
        ...
        clauses: [
          { n: '14.1', text: 'PAS does not control customer conduct.' },
          { n: '14.2', text: 'Each Merchant remains responsible for maintaining a safe and lawful environment within its establishment.' },
          { n: '14.3', text: 'PAS shall not ordinarily be responsible for acts or omissions of customers occurring at Merchant premises, except to the extent required under applicable law.' },
        ],
      },
      {
        n: '15',
        ...
        clauses: [
          { n: '15.1', text: 'PAS shall use reasonable efforts to maintain platform availability.' },
          { n: '15.2', text: "The Merchant acknowledges that interruptions, delays, temporary unavailability, or degradation of Platform services may occur due to maintenance activities, internet or telecommunications disruptions, cyber incidents, third-party service failures, software updates, system upgrades, regulatory requirements, security measures, payment processing issues, or other events beyond PAS's reasonable control." },
        ],
      },
      {
        n: '16',
      ...
      },
      {
        ...
        clauses: [
          { n: '17.1', text: 'To the maximum extent permitted by law, PAS shall not be liable for indirect, incidental, consequential, special, exemplary, or punitive damages.' },
          { n: '17.2', text: "PAS's aggregate liability arising out of or relating to this Agreement shall not exceed the total commissions earned by PAS from the Merchant during the three (3) months immediately preceding the event giving rise to the claim." },
        ],
      },
      {
        n: '18',
        ...
        clauses: [
          { n: '18.1', text: 'This Agreement shall remain in effect until terminated by either party.' },
          { n: '18.2', text: 'Either party may terminate this Agreement by providing written notice to the other party.' },
          { n: '18.3', text: 'PAS may immediately suspend or terminate access where reasonably required for legal compliance, customer protection, operational integrity, fraud prevention, or risk management.' },
        ],
      },
      {
        n: '19',
      ...
      },
      {
        ...
        clauses: [
          { n: '20.1', text: 'The Merchant acknowledges that customer-facing Terms and Conditions, cancellation policies, refund policies, exchange policies, operational guidelines, and other Platform rules published by PAS may apply to transactions conducted through the Platform.' },
          { n: '20.2', text: 'The Merchant agrees to comply with such policies as may be communicated by PAS from time to time.' },
          { n: '20.3', text: 'PAS may revise such policies in response to legal requirements, operational needs, fraud prevention measures, business requirements, or platform enhancements.' },
          { n: '20.4', text: 'PAS shall provide reasonable notice of material changes through official communication channels.' },
        ],
      },
      {
        n: '21',
